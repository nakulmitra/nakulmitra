...
I'm a passionate **Software Developer** with over 4.5+ years of experience in building robust backend systems using Java, Spring Boot, PostgreSQL and Redis. I enjoy solving complex problems, optimizing system performance and working on scalable microservice-based applications.


## 🧑‍💼 Professional Summary

- 💼 4.5+ years of backend development experience at **TCS**, currently working at **Sopra Steria**.
...
<!-- BEGIN YOUTUBE-CARDS -->
[![Optimistic Locking Isn't Enough | Build a Retry Mechanism in Spring Boot](https://ytcards.demolab.com/?id=9qye-qvogrs&title=Optimistic+Locking+Isn%27t+Enough+%7C+Build+a+Retry+Mechanism+in+Spring+Boot&lang=en&timestamp=1785469516&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "Optimistic Locking Isn't Enough | Build a Retry Mechanism in Spring Boot")](https://www.youtube.com/watch?v=9qye-qvogrs)
[![Optimistic Locking vs Pessimistic Locking | Spring Boot + PostgreSQL | Prevent Overselling](https://ytcards.demolab.com/?id=bqHlEAKYtAQ&title=Optimistic+Locking+vs+Pessimistic+Locking+%7C+Spring+Boot+%2B+PostgreSQL+%7C+Prevent+Overselling&lang=en&timestamp=1783841098&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "Optimistic Locking vs Pessimistic Locking | Spring Boot + PostgreSQL | Prevent Overselling")](https://www.youtube.com/watch?v=bqHlEAKYtAQ)
[![Long Polling vs SSE vs WebSocket Explained | Spring Boot Tutorial with Real-Time Chat Example](https://ytcards.demolab.com/?id=pWTBICCp2T4&title=Long+Polling+vs+SSE+vs+WebSocket+Explained+%7C+Spring+Boot+Tutorial+with+Real-Time+Chat+Example&lang=en&timestamp=1781842531&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "Long Polling vs SSE vs WebSocket Explained | Spring Boot Tutorial with Real-Time Chat Example")](https://www.youtube.com/watch?v=pWTBICCp2T4)
[![Polling vs Webhook Explained with Spring Boot | Real World Example & Implementation](https://ytcards.demolab.com/?id=wxe3DaEiZcI&title=Polling+vs+Webhook+Explained+with+Spring+Boot+%7C+Real+World+Example+%26+Implementation&lang=en&timestamp=1780632909&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "Polling vs Webhook Explained with Spring Boot | Real World Example & Implementation")](https://www.youtube.com/watch?v=wxe3DaEiZcI)
[![Race Conditions in Idempotent APIs | Redis Distributed Locking with Spring Boot](https://ytcards.demolab.com/?id=IQR5AogKX8o&title=Race+Conditions+in+Idempotent+APIs+%7C+Redis+Distributed+Locking+with+Spring+Boot&lang=en&timestamp=1779937505&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "Race Conditions in Idempotent APIs | Redis Distributed Locking with Spring Boot")](https://www.youtube.com/watch?v=IQR5AogKX8o)
[![Build Production Ready Idempotent APIs using Spring Boot, Redis & PostgreSQL](https://ytcards.demolab.com/?id=8HLXQiKsW-U&title=Build+Production+Ready+Idempotent+APIs+using+Spring+Boot%2C+Redis+%26+PostgreSQL&lang=en&timestamp=1779510607&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "Build Production Ready Idempotent APIs using Spring Boot, Redis & PostgreSQL")](https://www.youtube.com/watch?v=8HLXQiKsW-U)
<!-- END YOUTUBE-CARDS -->
